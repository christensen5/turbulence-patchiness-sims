...
i = 0
subfiglabels = "adbecf"
for sim in tqdm([data_v10_B0, data_v500_B0]):
    sim_id += 1
    ...
    #                         pad=20, fontsize=25)
    ax_shallow.set_title(["No reorientation;\n" + r"$v=10\mu m s^{{-1}}$", "No reorientation;\n" + r"$v=500\mu m s^{{-1}}$"][sim_id - 1], pad=20, fontsize=28)
...
# plt.show()
fig.savefig('/media/alexander/DATA/Ubuntu/Maarten/outputs/results123/initunif/comparison/Veff/3x2/100000p_Veff_0B_10vs500um_20-60s%s%s.png' % (surfstring, halfstring))