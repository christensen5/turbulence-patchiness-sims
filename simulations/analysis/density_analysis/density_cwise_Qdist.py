...
for simdata_dict in tqdm(all_motile_densities):
    ...
    for t in timestamps_for_dists:
        ...
        # keep only cells contained in patches, defined by f.
    ...
    fig_dists.savefig("/media/alexander/DATA/Ubuntu/Maarten/outputs/results123/initunif/comparison/density_cwise/Q/Qdist_cwise_f=%3.2f_%3.1fB_%dv_semilog_timesnaps_%s.png" % (f, simdata_dict["B"], simdata_dict["V"], avg_func.__name__))
