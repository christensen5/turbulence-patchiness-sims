...
for simdata_dict in tqdm(all_motile_densities):
    ...
    fig_dists.savefig("/media/alexander/DATA/Ubuntu/Maarten/outputs/results123/initunif/comparison/density_pwise/C/Cdist_pwise_%3.1fB_%dv_semilog_timesnaps.png" % (simdata_dict["B"], simdata_dict["V"]))
...
fig_dists.savefig("/media/alexander/DATA/Ubuntu/Maarten/outputs/results123/initunif/comparison/density_pwise/C/Cdist_pwise_dead_semilog_timesnaps.png")