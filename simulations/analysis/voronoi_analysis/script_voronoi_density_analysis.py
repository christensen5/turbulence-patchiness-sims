...
filepath_dead = "/media/alexander/DATA/Ubuntu/Maarten/outputs/sim123/initunif/dead/100000p_0-60s_0.01dt_0.1sdt_initunif_dead"
filepath_mot = "/media/alexander/DATA/Ubuntu/Maarten/outputs/sim123/initunif/mot/100000p_0-60s_0.01dt_0.1sdt_3.0B_10um_initunif_mot"

deps_dead = np.load(os.path.join(filepath_dead, 'deps2.npy'))
deps_mot = np.load(os.path.join(filepath_mot, 'deps2.npy'))
voronoi_volumes_dead = np.load(os.path.join(filepath_dead, 'vols2.npy'))
voronoi_volumes_mot = np.load(os.path.join(filepath_mot, 'vols2.npy'))
...
for t in tqdm(timestamps):
    ...
    conc_mot = concentrations_mot[:, t].flatten()
