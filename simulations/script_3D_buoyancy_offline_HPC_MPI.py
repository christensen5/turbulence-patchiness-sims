...
rank = comm.Get_rank()
pid = os.getpid()
memlog_savepath = "/home/alexander/Desktop/temp_results/MPI_trials/4core/memuseage_%dp_%schunksize_%d.%dprocs.npy" % (num_particles, str(chunksize[0]), ncores, rank)
...
timelog_savepath = os.path.join(os.path.dirname(memlog_savepath), "timer_%dp_%schunksize_%d.%dprocs.txt" % (num_particles, str(chunksize[0]), ncores, rank))#"/home/alexander/Desktop/temp_results/writeonce/timer_writeall.txt"
